...
require github.com/aschey/platune/client v0.0.0

require (
	github.com/alecthomas/chroma/v2 v2.5.0 // indirect
	github.com/alecthomas/participle/v2 v2.0.0-beta.5 // indirect
	github.com/aschey/bubbleprompt v0.0.0-20230308032611-864727980ae7 // indirect
	github.com/aschey/bubbleprompt-cobra v0.0.0-20230308032823-ae826b2a5c58 // indirect
