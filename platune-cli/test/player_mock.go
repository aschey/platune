...
//
//	mockgen -package=test -source=./../platuned/client/go/player_rpc_grpc.pb.go
//
...
func (m *MockPlayerClient) SubscribeEvents(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[platune.EventResponse], error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(grpc.ServerStreamingClient[platune.EventResponse])
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// SubscribeEvents mocks base method.
func (m *MockPlayerServer) SubscribeEvents(arg0 *emptypb.Empty, arg1 grpc.ServerStreamingServer[platune.EventResponse]) error {
	m.ctrl.T.Helper()
