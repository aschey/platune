...
type LookupEntry struct {
	...
	TrackNumber   int64                  `protobuf:"varint,6,opt,name=track_number,json=trackNumber,proto3" json:"track_number,omitempty"`
...
func (x *LookupEntry) GetTrackNumber() int64 {
	if x != nil {
...
func (x *LookupEntry) GetDuration() *durationpb.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
const file_management_proto_rawDesc = "" +
	"\n" +
	"\x10management.proto\x12\x15platune.management.v1\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\"X\n" +
	"\bProgress\x12\x10\n" +
	...
	"\x0falbum_artist_id\x18\x04 \x01(\x03R\ralbumArtistId\"\xe0\x01\n" +
	...
	"\ftrack_number\x18\x06 \x01(\x03R\vtrackNumber\x125\n" +
	"\bduration\x18\a \x01(\v2\x19.google.protobuf.DurationR\bduration\"N\n" +
...
var file_management_proto_depIdxs = []int32{
	...
	17, // 3: platune.management.v1.LookupEntry.duration:type_name -> google.protobuf.Duration
